...
")
	...
	->section("Header")
		->open_outersection()
			->section_order("header_section_order", "Drag & Drop Header Elements", array('options' => array("response_logo_icons" => "Logo + Icons", "response_logo_contact" => "Logo + Contact", "response_description_icons" => "Description + Icons", "response_logo_menu" => "Logo + SubMenu", "response_logo_Description" => "Logo + Description", "response_banner" => "Banner", "response_custom_header_element" => "Custom", "response_logo_register" => "Logo + Login"), 'default' => 'response_logo_icons'))
